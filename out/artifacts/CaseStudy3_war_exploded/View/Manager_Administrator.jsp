    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div style="margin-top: 40px; margin-bottom: 40px">
                ...
                <button type="button" class="btn btn-outline-primary"><a href="./myUser?action=register">Thêm User</a></button>
                <button type="button" class="btn btn-outline-success"><a href="./myUser?action=showAllUser">Quản lý nhân viên</a></button>
            </div>
        </div>
    <footer>
